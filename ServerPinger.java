...
public final class ServerPinger {
    ...
    private Result legacyPing(HInput input, HOutput output, boolean mc16) throws IOException {
        ...
        // Return ping status
        return new Result(onlinePlayers, maxPlayers, response, new ArrayList<>());
    }
    ...
    // Return ping status with modlist count
    return new Result(online, max, response, new ArrayList<>());
    }
    ...
    public static final class Result {
        ...
        public Result(int onlinePlayers, int maxPlayers, String raw, ArrayList sample) {
